                        ...
                        <x-slot name="notif">
                            ...
                            <div uk-dropdown="animation: uk-animation-slide-top-small; animate-out: true">
                                <ul class="uk-nav uk-dropdown-nav">
                                    <li class="uk-active" style="color: rgb(0, 0, 0);font-weight: bold;font-size:16px">
                                        Notification</li>
                                    @if (Auth::user()->unreadNotifications()->count() > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <li style="color: rgba(245, 210, 13, 0.815)">Aucun demande</li>
                                    @endif


                                    <li class="uk-nav-divider"></li>
                                    <li><a href="{{ route('notif') }}" style="color: black;font-weight:700">Tout
                                            lire</a>
                                    </li>
                                </ul>
                            </div>
