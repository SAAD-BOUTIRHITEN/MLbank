...
<body>
    ...
    <div class="work-steps" id="work-steps">
        ...
        <div class="container">
            <div class="aa">
                <form action="{{ route('remp') }}" class="formulario" id="formulario" method="POST">
                    @csrf
                    @method('POST')
                    ...
                    <div class="formulario__grupo" id="grupo__nombre">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="email" class="formulario__input" name="email" id="nombre"
                                placeholder="email">
                    ...
                    <div class="formulario__grupo" id="grupo__telefono">
                        ...
                        <div class="formulario__grupo" id="grupo__terminos">
                            <label class="formulario__label" style="color: blue">
